...
@section('content')
    ...
    <div class="modal-body pb-2">
        <div class="form-group row p-0 mb-1">
            <label for="name" class="col-sm-3 col-form-label">{{ __('Nama Unit Kerja') }}<sup class="text-danger">*</sup></label>
            <div class="col-sm-9">
        ...
        <div class="form-group row p-0 mb-1">
            ...
            <div class="col-sm-9">
                {{ Form::select('tipe_unit_kerja_id', $options_tipe_unit_kerja, null, ['id' => 'tipe_unit_kerja_id','class' => 'form-control select2', 'onchange' => "show_unit_kerja(this)"], $options_tipe_unit_kerja_attr) }}
        ...
        <div class="form-group row p-0 mb-1 unit" style="display: none;">
            ...
            <div class="col-sm-9">
                ...
                {{ Form::select('unit_kerja[]', $options_unit_kerja, null, ['multiple' => true,'class' => 'select2subunitkerja']) }}
